...
export default function DetailPanel({ event, isHost }) {
  ...
  return (
    <div style={{
      ...
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
            <span style={{ fontFamily: 'Outfit', fontSize: 12, color: C.yellowDeep, fontWeight: 600 }}>
        ...
        <div style={{ fontFamily: 'Outfit', fontSize: 13, color: C.textMuted, lineHeight: 1.7 }}>
      ...
      {/* Description */}
      <div style={{
        fontFamily: 'Outfit', fontSize: 14, color: C.textMid,
      ...
      <div style={{ background: C.bgCard, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: 16 }}>
        ...
        <div style={{ fontFamily: 'Outfit', fontSize: 12, color: C.textMuted, marginTop: 8, fontStyle: 'italic' }}>
      ...
      {!isHost && (
        <div style={{
          ...
          fontFamily: 'Outfit', fontSize: 12, color: C.yellowDeep, lineHeight: 1.6,
        }}>
      ...
      {!booked ? (
        <div style={{ background: C.bgCard, border: `1.5px solid ${C.border}`, borderRadius: 12, padding: 16 }}>
          ...
          {!isHost && (
            <>
              <div style={{ fontFamily: 'Outfit', fontSize: 13, color: C.textMid, marginBottom: 8 }}>
                Register as:
              </div>
                ...
                {[['♀ Female', 'female'], ['♂ Male', 'male'], ['Prefer not to say', 'other']].map(([label, val]) => (
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: 'Outfit', fontWeight: 600, fontSize: 12, cursor: 'pointer',
          ...
          <div style={{
            ...
            <span style={{ fontFamily: 'Outfit', color: C.textMuted, fontSize: 13 }}>Ticket price</span>
            <span style={{ fontFamily: 'Playfair Display, serif', fontWeight: 800, fontSize: 22, color: C.yellowDeep }}>
        ...
        <div style={{
          ...
          <div style={{ fontFamily: 'Outfit', fontSize: 13, color: C.greenSage }}>
